...
import React, { useState } from "react";
import FOOTER from "../components/Footer";
import { Button, TextField, Select, MenuItem, InputLabel, FormControl, Grid, Box, Typography } from "@mui/material";
import "../CSS/Addtrips.css"; // Updated styles are in this file
...
function TripForm() {
  ...
  return (
    <>
    <div className="trip-form-container" style={{ backgroundColor: "#f0f8ff", width: "100%", height:"100%" }}>
      <Typography variant="h3" align="center" gutterBottom className="trip-form-title" style={{ color: "#0275d8", fontWeight: "bold" }}>
        Add New Trip
      </Typography>
      

      <form onSubmit={handleSubmit} className="trip-form" style={{ maxWidth: "900px", margin: "auto", marginBottom:"60px",backgroundColor: "#ffffff", padding: "30px", borderRadius: "15px", boxShadow: "0 4px 8px rgba(0, 0, 0, 0.1)" }}>
        <Grid container spacing={3}>
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              required
              className="trip-form-input"
              InputProps={{ style: { borderRadius: "10px", backgroundColor: "#f5f5f5" } }}
            />
          </Grid>
          <Grid item xs={12} sm={6}>
            <TextField
        ...
        <Box className="trip-itinerary-container" style={{ marginTop: "30px" }}>
          <Typography variant="h5" className="trip-itinerary-title" style={{ color: "#0275d8", fontWeight: "bold", marginBottom: "20px" }}>
            Trip Itinerary
          </Typography>
          {trip.itinerary.map((day, index) => (
            <div key={index} className="trip-itinerary-day" style={{ marginBottom: "30px", padding: "20px", backgroundColor: "#f9f9f9", borderRadius: "10px" }}>
              <Typography variant="h6" style={{ color: "#0275d8", fontWeight: "bold" }}>
                Day {day.day}
              </Typography>
                ...
                <Grid item xs={12} sm={6}>
                  <FormControl fullWidth>
                    ...
                    <Select
                      value={day.modeOfTransportation}
                      onChange={(e) =>
                        handleItineraryChange(index, "modeOfTransportation", e.target.value)
                      }
                    ...
                    <Grid container spacing={3}>
                      <Grid item xs={12} sm={4}>
                        <TextField
                          ...
                          onChange={(e) => {
                            const updatedActivities = [...day.activities];
                            updatedActivities[activityIndex].time = e.target.value;
                      ...
                      <Grid item xs={12} sm={4}>
                        <TextField
                          ...
                          onChange={(e) => {
                            const updatedActivities = [...day.activities];
                            updatedActivities[activityIndex].location = e.target.value;
                            handleItineraryChange(index, "activities", updatedActivities);
                          }}
                          fullWidth
                          variant="outlined"
              ...
              <Button
                ...
                color="secondary"
                onClick={() => addActivity(index)}
                style={{marginLeft:"330px", marginTop: "20px", backgroundColor:"#d9534f", color: "white", fontWeight: "bold"}}
              >
                Add Activity
              </Button>
            </div>
          ...
          <Button
            ...
            color="primary"
            onClick={addDay}
            style={{ marginLeft:"370px",marginTop: "30px" , backgroundColor:"#37474f", color: "white", fontWeight: "bold"}}
          >
            Add Day
          </Button>
        </Box>
