    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='dateSet'>
          ...
          <label>
            Budget:
            <input type="number" className='budget' name="budget" value={trip.budget} onChange={handleInputChange} required />
          </label>

        </div>
        <h4 className="text-center mb-4" style={{ color: "#000000", backgroundColor: "#fff5e6", padding: "10px" }}>
          Itinerary
        </h4>
          ...
          {trip.itinerary.map((day, index) => (
            <div key={index} className="day-card">
                ...
                <button type="button" className="btn btn-primary" onClick={() => addActivity(index)}>
                  Add Activity
                </button>
                </div>
            ...
            <div className='add'>
              <button type="button" className="btn btn-secondary mb-3" onClick={addDay}>
                Add Day
              </button>
            </div>
